"use strict";
(self["webpackChunktest"] = self["webpackChunktest"] || []).push([[830],{
...
// EXTERNAL MODULE: ./node_modules/.pnpm/@cesium+engine@24.0.0/node_modules/@cesium/engine/Source/Core/Ion.js
var Ion = __webpack_require__(96964);
// EXTERNAL MODULE: ./node_modules/.pnpm/@cesium+widgets@14.5.0/node_modules/@cesium/widgets/Source/Viewer/Viewer.js + 367 modules
var Viewer = __webpack_require__(12064);
// EXTERNAL MODULE: ./node_modules/.pnpm/@cesium+engine@24.0.0/node_modules/@cesium/engine/Source/Scene/Terrain.js + 1 modules
var Terrain = __webpack_require__(26482);
// EXTERNAL MODULE: ./node_modules/.pnpm/@cesium+engine@24.0.0/node_modules/@cesium/engine/Source/Scene/createOsmBuildingsAsync.js
var createOsmBuildingsAsync = __webpack_require__(88729);
// EXTERNAL MODULE: ./node_modules/.pnpm/@cesium+engine@24.0.0/node_modules/@cesium/engine/Source/Core/Cartesian3.js
var Cartesian3 = __webpack_require__(32355);
// EXTERNAL MODULE: ./node_modules/.pnpm/@cesium+engine@24.0.0/node_modules/@cesium/engine/Source/Core/Color.js
var Color = __webpack_require__(8365);
// EXTERNAL MODULE: ./node_modules/.pnpm/@cesium+engine@24.0.0/node_modules/@cesium/engine/Source/Core/JulianDate.js
var JulianDate = __webpack_require__(74494);
// EXTERNAL MODULE: ./node_modules/.pnpm/@cesium+engine@24.0.0/node_modules/@cesium/engine/Source/DataSources/SampledPositionProperty.js + 3 modules
var SampledPositionProperty = __webpack_require__(38139);
// EXTERNAL MODULE: ./node_modules/.pnpm/@cesium+engine@24.0.0/node_modules/@cesium/engine/Source/Core/IonResource.js
var IonResource = __webpack_require__(71256);
// EXTERNAL MODULE: ./node_modules/.pnpm/@cesium+engine@24.0.0/node_modules/@cesium/engine/Source/Core/TimeIntervalCollection.js
var TimeIntervalCollection = __webpack_require__(8188);
// EXTERNAL MODULE: ./node_modules/.pnpm/@cesium+engine@24.0.0/node_modules/@cesium/engine/Source/Core/TimeInterval.js
var TimeInterval = __webpack_require__(46180);
// EXTERNAL MODULE: ./node_modules/.pnpm/@cesium+engine@24.0.0/node_modules/@cesium/engine/Source/DataSources/VelocityOrientationProperty.js
var VelocityOrientationProperty = __webpack_require__(83511);
// EXTERNAL MODULE: ./node_modules/.pnpm/@cesium+engine@24.0.0/node_modules/@cesium/engine/Source/DataSources/PathGraphics.js
var PathGraphics = __webpack_require__(3587);
;// ./data/line-fly.js
const line_fly = JSON.parse(
...
;// ./node_modules/.pnpm/vue-loader@17.4.2_vue@3.5.32_webpack@5.106.1/node_modules/vue-loader/dist/index.js??ruleSet[1].rules[6].use[0]!./src/web/view/cesiumDemo/index.vue?vue&type=script&setup=true&lang=js


const _hoisted_1 = { class: "cesium-demo" }
const _hoisted_2 = { class: "tool-list" }
...
/* harmony default export */ const cesiumDemovue_type_script_setup_true_lang_js = ({
  __name: 'index',
  setup(__props) {

window.CESIUM_BASE_URL = '/public/Cesium';
// cesium 配置项
Ion/* default */.A.defaultAccessToken =
...
function createViewer() {
  // 创建视图
  viewer = new Viewer/* default */.A('cesiumContainer', {
    terrain: Terrain/* default */.A.fromWorldTerrain(), //地形，世界地形地图
    infoBox: false, //禁用
  });
}
async function addBuild() {
  // 添加 建筑数据
  const osmBuildings = await createOsmBuildingsAsync/* default */.A();
...
function addPoint() {
  ...
  const pointEntity = viewer.entities.add({
    ...
    position: Cartesian3/* default */.A.fromDegrees(
      dataPoint.longitude,
      dataPoint.latitude,
      dataPoint.height
    ),
    point: { pixelSize: 10, color: Color/* default */.A.RED },
  });
...
function addFlyTime() {
  ...
  start = JulianDate/* default */.A.fromIso8601('2020-03-09T23:10:00Z');
  stop = JulianDate/* default */.A.addSeconds(
    start,
    totalSeconds,
    new JulianDate/* default */.A()
  );
  ...
  positionProperty = new SampledPositionProperty/* default */.A();

  for (let i = 0; i < flightData.length; i++) {
    const dataPoint = flightData[i];
    const time = JulianDate/* default */.A.addSeconds(
      start,
      i * timeStepInSeconds,
      new JulianDate/* default */.A()
    );
    // 创建一个点
    const position = Cartesian3/* default */.A.fromDegrees(
      dataPoint.longitude,
      dataPoint.latitude,
      dataPoint.height
    );
...
async function loadModel() {
  ...
  //  加载模型
  const airplaneUri = await IonResource/* default */.A.fromAssetId(2539726);
  const airplaneEntity = viewer.entities.add({
    availability: new TimeIntervalCollection/* default */.A([
      new TimeInterval/* default */.A({ start: start, stop: stop }),
    ]),
    position: positionProperty,
    model: { uri: airplaneUri },
    orientation: new VelocityOrientationProperty/* default */.A(positionProperty),
    path: new PathGraphics/* default */.A({ width: 3 }),
  });
...
function distanceTo() {
  let left = {},
    right = {};
  Cartesian3/* default */.A.distance(left, right);
}
...
return (_ctx, _cache) => {
  ...
  return ((0,runtime_core_esm_bundler/* openBlock */.uX)(), (0,runtime_core_esm_bundler/* createElementBlock */.CE)("div", _hoisted_1, [
    _cache[2] || (_cache[2] = (0,runtime_core_esm_bundler/* createElementVNode */.Lk)("div", { id: "cesiumContainer" }, null, -1 /* CACHED */)),
    (0,runtime_core_esm_bundler/* createElementVNode */.Lk)("div", _hoisted_2, [
      (0,runtime_core_esm_bundler/* createVNode */.bF)(_component_el_button, {
        class: "tool",
        size: "small",
        onClick: _cache[0] || (_cache[0] = $event => (distanceTo()))
      }, {
        default: (0,runtime_core_esm_bundler/* withCtx */.k6)(() => [...(_cache[1] || (_cache[1] = [
          (0,runtime_core_esm_bundler/* createTextVNode */.eW)(" 距离测量 ", -1 /* CACHED */)
        ]))]),
        _: 1 /* STABLE */
      })
    ])
...
;// ./src/web/view/cesiumDemo/index.vue?vue&type=script&setup=true&lang=js
...
;// ./src/web/view/cesiumDemo/index.vue
...
const __exports__ = /*#__PURE__*/(0,exportHelper/* default */.A)(cesiumDemovue_type_script_setup_true_lang_js, [['__scopeId',"data-v-065976c3"]])

/* harmony default export */ const cesiumDemo = (__exports__);
