            ...
            <el-row>
                <el-col :span="12" v-if="form.randomNum === '1'">
                    <el-form-item label="字段">
                        <el-select v-model="form.fieldList" multiple filterable allow-create :reserve-keyword="false"
                            placeholder="生成字段" style="width: 240px" @change="fieldListChange">
                            <el-option v-for="item in fieldListOps" :key="item.value" :label="item.label"
                                :value="item.value">
                ...
                <el-col :span="12" v-if="form.randomNum === '2'">
                    <el-form-item label="输入内容">
                        <el-input v-model="form.inputStr" style="width: 100%" :rows="2" type="textarea"
                            placeholder="" />
                    </el-form-item>
                </el-col>
            </el-row>
            ...
            <el-row>
                <el-col :span="12" v-if="form.randomNum === '2'">
                    <el-form-item label="分割字段">
                        <el-input v-model="form.defaultSplit" />
                    </el-form-item>
                </el-col>
                <el-col :span="12">
                    ...
                    <com-table :column-data="columnData" :table-data="fieldTableData">
                        <template #value="scope">
                            <div style="display: flex; align-items: center">
                                <span style="margin-left: 10px"> <el-input v-model="scope.row.value" style="width: 100%"
                                        placeholder="" /> </span>
                            </div>
                        </template>
                        <template #increasing="scope">
                            <div style="display: flex; align-items: center">
                                <span style="margin-left: 10px"> <el-switch v-model="scope.row.increasing" /> </span>
                            </div>
                        </template>
                    </com-table>
                </el-col>
            ...
            <el-row>
                <el-col :span="24">
                    <el-form-item label="生成内容">
                        <el-input v-model="form.output" style="width: 100%" :rows="6" type="textarea" placeholder="" />
                    </el-form-item>
                </el-col>
            </el-row>
            <el-form-item>
