(self["webpackChunktest"] = self["webpackChunktest"] || []).push([[198],{
...
// EXTERNAL MODULE: ./node_modules/.pnpm/ant-design-vue@4.2.6_vue@3.5.32/node_modules/ant-design-vue/es/modal/index.js
var modal = __webpack_require__(1262);
// EXTERNAL MODULE: ./node_modules/.pnpm/ant-design-vue@4.2.6_vue@3.5.32/node_modules/ant-design-vue/es/button/index.js + 5 modules
var es_button = __webpack_require__(49518);
// EXTERNAL MODULE: ./node_modules/.pnpm/ant-design-vue@4.2.6_vue@3.5.32/node_modules/ant-design-vue/es/input/index.js
var input = __webpack_require__(81475);
// EXTERNAL MODULE: ./node_modules/.pnpm/@ant-design+icons-vue@7.0.1_vue@3.5.32/node_modules/@ant-design/icons-vue/es/icons/PlusOutlined.js + 1 modules
var PlusOutlined = __webpack_require__(9101);
// EXTERNAL MODULE: ./node_modules/.pnpm/@ant-design+icons-vue@7.0.1_vue@3.5.32/node_modules/@ant-design/icons-vue/es/icons/DeleteOutlined.js + 1 modules
var DeleteOutlined = __webpack_require__(38557);
// EXTERNAL MODULE: ./node_modules/.pnpm/@ant-design+icons-vue@7.0.1_vue@3.5.32/node_modules/@ant-design/icons-vue/es/icons/EditOutlined.js + 1 modules
var EditOutlined = __webpack_require__(94082);
...
;// ./node_modules/.pnpm/vue-loader@17.4.2_vue@3.5.32_webpack@5.106.1/node_modules/vue-loader/dist/index.js??ruleSet[1].rules[6].use[0]!./src/web/view/plan/index.vue?vue&type=script&setup=true&lang=js
...
const _hoisted_10 = { style: {"margin-left":"8px"} }
const _hoisted_11 = { style: {"color":"red","font-weight":"bold"} }
const _hoisted_12 = { style: {"text-align":"center","padding":"20px"} }
const _hoisted_13 = {
  key: 0,
...
const dataSource = (0,reactivity_esm_bundler/* ref */.KR)([]);

// 自定义列
const customColumns = (0,reactivity_esm_bundler/* ref */.KR)([]);

// 表格列定义
const columns = (0,reactivity_esm_bundler/* reactive */.Kh)([
  {
    title: "名称",
    dataIndex: "name",
    key: "name",
...
// 用于触发表格重新渲染的key
const tableKey = (0,reactivity_esm_bundler/* ref */.KR)(0);

// Modal相关
const modalVisible = (0,reactivity_esm_bundler/* ref */.KR)(false);
const customColumnName = (0,reactivity_esm_bundler/* ref */.KR)("");
const modalConfirmLoading = (0,reactivity_esm_bundler/* ref */.KR)(false);

// 编辑行的Modal相关
const editModalVisible = (0,reactivity_esm_bundler/* ref */.KR)(false);
const editForm = (0,reactivity_esm_bundler/* ref */.KR)({
  key: "",
  name: "",
  code: "",
  price: 0,
...
// 饼图相关
const chartVisible = (0,reactivity_esm_bundler/* ref */.KR)(true);
let pieChart = null;
...
const showUploadModal = (0,reactivity_esm_bundler/* ref */.KR)(false);
...
const initChart = () => {
  ...
  if (pieChartDom) {
    if (!pieChart) {
      pieChart = echarts/* init */.Ts(pieChartDom);
    }
  ...
  if (barChartDom) {
    if (!barChart) {
      barChart = echarts/* init */.Ts(barChartDom);
    }
...
// 预测相关
const predictVisible = (0,reactivity_esm_bundler/* ref */.KR)(false);
const predictData = (0,reactivity_esm_bundler/* ref */.KR)(null);
...
const initPredictChart = (record, years, values, predictions) => {
  ...
  if (!predictChart) {
    predictChart = echarts/* init */.Ts(predictChartDom);
  } else {
    predictChart.clear();
  }
...
return (_ctx, _cache) => {
  const _component_DownloadOutlined = (0,runtime_core_esm_bundler/* resolveComponent */.g2)("DownloadOutlined")
  const _component_UploadOutlined = (0,runtime_core_esm_bundler/* resolveComponent */.g2)("UploadOutlined")
  const _component_a_popconfirm = (0,runtime_core_esm_bundler/* resolveComponent */.g2)("a-popconfirm")
  const _component_a_table = (0,runtime_core_esm_bundler/* resolveComponent */.g2)("a-table")
  const _component_a_modal = (0,runtime_core_esm_bundler/* resolveComponent */.g2)("a-modal")
  ...
  const _component_a_table_column = (0,runtime_core_esm_bundler/* resolveComponent */.g2)("a-table-column")
  ...
  return ((0,runtime_core_esm_bundler/* openBlock */.uX)(), (0,runtime_core_esm_bundler/* createElementBlock */.CE)("div", _hoisted_1, [
    (0,runtime_core_esm_bundler/* createElementVNode */.Lk)("div", _hoisted_2, [
      (0,runtime_core_esm_bundler/* createVNode */.bF)((0,reactivity_esm_bundler/* unref */.R1)(es_button/* default */.A), {
        type: "primary",
        onClick: addRow,
        style: {"margin-right":"8px"}
      }, {
        default: (0,runtime_core_esm_bundler/* withCtx */.k6)(() => [
          (0,runtime_core_esm_bundler/* createVNode */.bF)((0,reactivity_esm_bundler/* unref */.R1)(PlusOutlined/* default */.A)),
          _cache[15] || (_cache[15] = (0,runtime_core_esm_bundler/* createTextVNode */.eW)(" 添加行 ", -1 /* CACHED */))
        ]),
        _: 1 /* STABLE */
      }),
      (0,runtime_core_esm_bundler/* createVNode */.bF)((0,reactivity_esm_bundler/* unref */.R1)(es_button/* default */.A), {
        ...
        default: (0,runtime_core_esm_bundler/* withCtx */.k6)(() => [
          (0,runtime_core_esm_bundler/* createVNode */.bF)((0,reactivity_esm_bundler/* unref */.R1)(PlusOutlined/* default */.A)),
          _cache[16] || (_cache[16] = (0,runtime_core_esm_bundler/* createTextVNode */.eW)(" 添加自定义列 ", -1 /* CACHED */))
        ]),
        _: 1 /* STABLE */
      }),
      (0,runtime_core_esm_bundler/* createVNode */.bF)((0,reactivity_esm_bundler/* unref */.R1)(es_button/* default */.A), {
        ...
        default: (0,runtime_core_esm_bundler/* withCtx */.k6)(() => [
          (0,runtime_core_esm_bundler/* createVNode */.bF)(_component_DownloadOutlined),
          _cache[17] || (_cache[17] = (0,runtime_core_esm_bundler/* createTextVNode */.eW)(" 导出Excel ", -1 /* CACHED */))
        ]),
        _: 1 /* STABLE */
      }),
      (0,runtime_core_esm_bundler/* createVNode */.bF)((0,reactivity_esm_bundler/* unref */.R1)(es_button/* default */.A), {
        ...
        default: (0,runtime_core_esm_bundler/* withCtx */.k6)(() => [
          (0,runtime_core_esm_bundler/* createVNode */.bF)(_component_UploadOutlined),
          _cache[18] || (_cache[18] = (0,runtime_core_esm_bundler/* createTextVNode */.eW)(" 导入Excel ", -1 /* CACHED */))
        ]),
        _: 1 /* STABLE */
      }),
      (0,runtime_core_esm_bundler/* createVNode */.bF)((0,reactivity_esm_bundler/* unref */.R1)(es_button/* default */.A), { onClick: showChart }, {
        default: (0,runtime_core_esm_bundler/* withCtx */.k6)(() => [
          (0,runtime_core_esm_bundler/* createElementVNode */.Lk)("span", null, (0,shared_esm_bundler/* toDisplayString */.v_)(chartVisible.value ? "隐藏图表" : "显示图表"), 1 /* TEXT */)
        ]),
        _: 1 /* STABLE */
      })
    ]),
    ((0,runtime_core_esm_bundler/* openBlock */.uX)(), (0,runtime_core_esm_bundler/* createBlock */.Wv)(_component_a_table, {
      key: tableKey.value,
      ...
      headerCell: (0,runtime_core_esm_bundler/* withCtx */.k6)(({ column }) => [
        (customColumns.value.some((col) => col.key === column.key))
          ? ((0,runtime_core_esm_bundler/* openBlock */.uX)(), (0,runtime_core_esm_bundler/* createElementBlock */.CE)("div", _hoisted_3, [
              (0,runtime_core_esm_bundler/* createElementVNode */.Lk)("span", null, (0,shared_esm_bundler/* toDisplayString */.v_)(column.title), 1 /* TEXT */),
              (0,runtime_core_esm_bundler/* createVNode */.bF)(_component_a_popconfirm, {
                title: "确定要删除这一列吗?",
                ...
                default: (0,runtime_core_esm_bundler/* withCtx */.k6)(() => [
                  (0,runtime_core_esm_bundler/* createVNode */.bF)((0,reactivity_esm_bundler/* unref */.R1)(DeleteOutlined/* default */.A), { style: {"color":"#ff4d4f","cursor":"pointer"} })
                ]),
                _: 1 /* STABLE */
              }, 8 /* PROPS */, ["onConfirm"])
            ]))
          : ((0,runtime_core_esm_bundler/* openBlock */.uX)(), (0,runtime_core_esm_bundler/* createElementBlock */.CE)(runtime_core_esm_bundler/* Fragment */.FK, { key: 1 }, [
              (0,runtime_core_esm_bundler/* createTextVNode */.eW)((0,shared_esm_bundler/* toDisplayString */.v_)(column.title), 1 /* TEXT */)
            ], 64 /* STABLE_FRAGMENT */))
      ]),
      bodyCell: (0,runtime_core_esm_bundler/* withCtx */.k6)(({ column, text, record }) => [
        (column.dataIndex == 'name')
          ? ((0,runtime_core_esm_bundler/* openBlock */.uX)(), (0,runtime_core_esm_bundler/* createBlock */.Wv)((0,reactivity_esm_bundler/* unref */.R1)(input/* default */.Ay), {
              key: 0,
              value: text,
            ...
            : (column.dataIndex == 'price')
              ...
              (e) => updateCell(record.key, 'interest', Number(e.target.value))
                  ...
                  : (column.dataIndex == 'total')
                    ? ((0,runtime_core_esm_bundler/* openBlock */.uX)(), (0,runtime_core_esm_bundler/* createElementBlock */.CE)("span", _hoisted_4, (0,shared_esm_bundler/* toDisplayString */.v_)(text), 1 /* TEXT */))
                ...
                border: '1px solid #d9d9d9',
                          ...
                          (0,runtime_core_esm_bundler/* createElementVNode */.Lk)("span", null, (0,shared_esm_bundler/* toDisplayString */.v_)(text), 1 /* TEXT */),
                      ...
                      : (column.dataIndex == 'action')
                        ? ((0,runtime_core_esm_bundler/* openBlock */.uX)(), (0,runtime_core_esm_bundler/* createElementBlock */.CE)("div", _hoisted_7, [
                            (0,runtime_core_esm_bundler/* createVNode */.bF)((0,reactivity_esm_bundler/* unref */.R1)(es_button/* default */.A), {
                              size: "small",
                              onClick: $event => (showEditModal(record))
                            }, {
                              default: (0,runtime_core_esm_bundler/* withCtx */.k6)(() => [
                                (0,runtime_core_esm_bundler/* createVNode */.bF)((0,reactivity_esm_bundler/* unref */.R1)(EditOutlined/* default */.A))
                              ]),
                              _: 1 /* STABLE */
                            }, 8 /* PROPS */, ["onClick"]),
                            (0,runtime_core_esm_bundler/* createVNode */.bF)((0,reactivity_esm_bundler/* unref */.R1)(es_button/* default */.A), {
                              ...
                              default: (0,runtime_core_esm_bundler/* withCtx */.k6)(() => [...(_cache[19] || (_cache[19] = [
                                (0,runtime_core_esm_bundler/* createTextVNode */.eW)(" 预测 ", -1 /* CACHED */)
                              ]))]),
                              _: 1 /* STABLE */
                            }, 8 /* PROPS */, ["onClick"]),
                            (0,runtime_core_esm_bundler/* createVNode */.bF)(_component_a_popconfirm, {
                              ...
                              default: (0,runtime_core_esm_bundler/* withCtx */.k6)(() => [
                                (0,runtime_core_esm_bundler/* createVNode */.bF)((0,reactivity_esm_bundler/* unref */.R1)(es_button/* default */.A), {
                                  ...
                                  default: (0,runtime_core_esm_bundler/* withCtx */.k6)(() => [
                                    (0,runtime_core_esm_bundler/* createVNode */.bF)((0,reactivity_esm_bundler/* unref */.R1)(DeleteOutlined/* default */.A))
                                  ]),
                                  _: 1 /* STABLE */
                                })
                              ]),
                        ...
                        : ((0,runtime_core_esm_bundler/* openBlock */.uX)(), (0,runtime_core_esm_bundler/* createElementBlock */.CE)(runtime_core_esm_bundler/* Fragment */.FK, { key: 8 }, [
                            (0,runtime_core_esm_bundler/* createCommentVNode */.Q3)(" 自定义列渲染 "),
                            (0,runtime_core_esm_bundler/* createVNode */.bF)((0,reactivity_esm_bundler/* unref */.R1)(input/* default */.Ay), {
                              value: text,
                              onChange: 
    ...
    (0,runtime_core_esm_bundler/* createCommentVNode */.Q3)(" 图表容器 "),
    (0,runtime_core_esm_bundler/* withDirectives */.bo)((0,runtime_core_esm_bundler/* createElementVNode */.Lk)("div", _hoisted_8, [...(_cache[20] || (_cache[20] = [
      (0,runtime_core_esm_bundler/* createElementVNode */.Lk)("div", { class: "chart-wrapper" }, [
        (0,runtime_core_esm_bundler/* createCommentVNode */.Q3)(" 饼图 "),
        (0,runtime_core_esm_bundler/* createElementVNode */.Lk)("div", {
          id: "pie-chart",
          class: "chart-item"
        }),
        (0,runtime_core_esm_bundler/* createCommentVNode */.Q3)(" 柱状图 "),
        (0,runtime_core_esm_bundler/* createElementVNode */.Lk)("div", {
          id: "bar-chart",
          class: "chart-item"
        })
      ...
      [runtime_dom_esm_bundler/* vShow */.aG, chartVisible.value]
    ]),
    (0,runtime_core_esm_bundler/* createCommentVNode */.Q3)(" 添加自定义列的Modal "),
    (0,runtime_core_esm_bundler/* createVNode */.bF)(_component_a_modal, {
    ...
    (0,runtime_core_esm_bundler/* createCommentVNode */.Q3)(" 编辑行的Modal "),
    (0,runtime_core_esm_bundler/* createVNode */.bF)(_component_a_modal, {
      ...
      default: (0,runtime_core_esm_bundler/* withCtx */.k6)(() => [
        (0,runtime_core_esm_bundler/* createVNode */.bF)(_component_a_form, {
          ...
          default: (0,runtime_core_esm_bundler/* withCtx */.k6)(() => [
            (0,runtime_core_esm_bundler/* createVNode */.bF)(_component_a_form_item, { label: "名称" }, {
              default: (0,runtime_core_esm_bundler/* withCtx */.k6)(() => [
                (0,runtime_core_esm_bundler/* createVNode */.bF)((0,reactivity_esm_bundler/* unref */.R1)(input/* default */.Ay), {
            ...
            (0,runtime_core_esm_bundler/* createVNode */.bF)(_component_a_form_item, { label: "代码" }, {
              default: (0,runtime_core_esm_bundler/* withCtx */.k6)(() => [
                (0,runtime_core_esm_bundler/* createVNode */.bF)((0,reactivity_esm_bundler/* unref */.R1)(input/* default */.Ay), {
            ...
            (0,runtime_core_esm_bundler/* createVNode */.bF)(_component_a_form_item, { label: "价格" }, {
              default: (0,runtime_core_esm_bundler/* withCtx */.k6)(() => [
            ...
            (0,runtime_core_esm_bundler/* createVNode */.bF)(_component_a_form_item, { label: "数量" }, {
              default: (0,runtime_core_esm_bundler/* withCtx */.k6)(() => [
                (0,runtime_core_esm_bundler/* createVNode */.bF)(_component_a_input_number, {
            ...
            (0,runtime_core_esm_bundler/* createVNode */.bF)(_component_a_form_item, { label: "增长率" }, {
              default: (0,runtime_core_esm_bundler/* withCtx */.k6)(() => [
                (0,runtime_core_esm_bundler/* createVNode */.bF)(_component_a_input_number, {
            ...
            (0,runtime_core_esm_bundler/* createCommentVNode */.Q3)(" 颜色选择 "),
            (0,runtime_core_esm_bundler/* createVNode */.bF)(_component_a_form_item, { label: "颜色" }, {
              default: (0,runtime_core_esm_bundler/* withCtx */.k6)(() => [
                ...
                border: '1px solid #d9d9d9',
                  ...
                  (0,runtime_core_esm_bundler/* createElementVNode */.Lk)("span", _hoisted_10, (0,shared_esm_bundler/* toDisplayString */.v_)(editForm.value.color), 1 /* TEXT */)
                ])
              ]),
              _: 1 /* STABLE */
            }),
            (0,runtime_core_esm_bundler/* createCommentVNode */.Q3)(" 动态生成自定义列的表单项 "),
            ((0,runtime_core_esm_bundler/* openBlock */.uX)(true), (0,runtime_core_esm_bundler/* createElementBlock */.CE)(runtime_core_esm_bundler/* Fragment */.FK, null, (0,runtime_core_esm_bundler/* renderList */.pI)(getCustomColumnKeys(), (customCol) => {
              return ((0,runtime_core_esm_bundler/* openBlock */.uX)(), (0,runtime_core_esm_bundler/* createBlock */.Wv)(_component_a_form_item, {
                key: customCol.key,
            ...
            (0,runtime_core_esm_bundler/* createCommentVNode */.Q3)(" 总值字段显示在最后，用红色标记 "),
            (0,runtime_core_esm_bundler/* createVNode */.bF)(_component_a_form_item, { label: "总值" }, {
              default: (0,runtime_core_esm_bundler/* withCtx */.k6)(() => [
                (0,runtime_core_esm_bundler/* createElementVNode */.Lk)("span", _hoisted_11, (0,shared_esm_bundler/* toDisplayString */.v_)((editForm.value.price * editForm.value.quantity).toFixed(2)), 1 /* TEXT */)
              ]),
              _: 1 /* STABLE */
            })
          ]),
    ...
    (0,runtime_core_esm_bundler/* createCommentVNode */.Q3)(" 导入Excel的Modal "),
    (0,runtime_core_esm_bundler/* createVNode */.bF)(_component_a_modal, {
      ...
      default: (0,runtime_core_esm_bundler/* withCtx */.k6)(() => [
        (0,runtime_core_esm_bundler/* createElementVNode */.Lk)("div", _hoisted_12, [
          _cache[22] || (_cache[22] = (0,runtime_core_esm_bundler/* createElementVNode */.Lk)("p", { style: {"margin-bottom":"20px"} }, [
            (0,runtime_core_esm_bundler/* createTextVNode */.eW)(" 导入新的Excel文件将覆盖当前所有数据。"),
            (0,runtime_core_esm_bundler/* createElementVNode */.Lk)("br"),
            (0,runtime_core_esm_bundler/* createTextVNode */.eW)(" 导入前已自动导出当前数据作为备份。 ")
          ], -1 /* CACHED */)),
          (0,runtime_core_esm_bundler/* createVNode */.bF)(_component_a_upload, {
            ...
            default: (0,runtime_core_esm_bundler/* withCtx */.k6)(() => [
              (0,runtime_core_esm_bundler/* createVNode */.bF)(_component_a_button, null, {
                default: (0,runtime_core_esm_bundler/* withCtx */.k6)(() => [
                  (0,runtime_core_esm_bundler/* createVNode */.bF)(_component_UploadOutlined),
                  _cache[21] || (_cache[21] = (0,runtime_core_esm_bundler/* createTextVNode */.eW)(" 选择Excel文件 ", -1 /* CACHED */))
                ]),
                _: 1 /* STABLE */
              })
            ]),
    ...
    (0,runtime_core_esm_bundler/* createCommentVNode */.Q3)(" 预测图表容器 "),
    (0,runtime_core_esm_bundler/* createVNode */.bF)(_component_a_modal, {
      ...
      default: (0,runtime_core_esm_bundler/* withCtx */.k6)(() => [
        _cache[24] || (_cache[24] = (0,runtime_core_esm_bundler/* createElementVNode */.Lk)("div", {
          id: "predict-chart",
          style: {"width":"100%","height":"500px"}
        }, null, -1 /* CACHED */)),
        (predictData.value)
          ? ((0,runtime_core_esm_bundler/* openBlock */.uX)(), (0,runtime_core_esm_bundler/* createElementBlock */.CE)("div", _hoisted_13, [
              _cache[23] || (_cache[23] = (0,runtime_core_esm_bundler/* createElementVNode */.Lk)("h3", null, "预测结果", -1 /* CACHED */)),
              (0,runtime_core_esm_bundler/* createElementVNode */.Lk)("p", null, " 基于智能预测算法（模式识别+加权线性回归）预测「" + (0,shared_esm_bundler/* toDisplayString */.v_)(predictData.value.record.name) + "」未来三年的趋势： ", 1 /* TEXT */),
              (0,runtime_core_esm_bundler/* createVNode */.bF)(_component_a_table, {
                dataSource: predictData.value.predictions,
                pagination: false,
                size: "small"
              }, {
                default: (0,runtime_core_esm_bundler/* withCtx */.k6)(() => [
                  (0,runtime_core_esm_bundler/* createVNode */.bF)(_component_a_table_column, {
                    title: "年份",
                    dataIndex: "year"
                  }, {
                    default: (0,runtime_core_esm_bundler/* withCtx */.k6)((text) => [
                      (0,runtime_core_esm_bundler/* createTextVNode */.eW)((0,shared_esm_bundler/* toDisplayString */.v_)(text), 1 /* TEXT */)
                    ]),
                    _: 1 /* STABLE */
                  }),
                  (0,runtime_core_esm_bundler/* createVNode */.bF)(_component_a_table_column, {
                    ...
                    default: (0,runtime_core_esm_bundler/* withCtx */.k6)((text) => [
                      (0,runtime_core_esm_bundler/* createTextVNode */.eW)((0,shared_esm_bundler/* toDisplayString */.v_)(typeof text === "object"
...
;// ./src/web/view/plan/index.vue?vue&type=script&setup=true&lang=js
...
const __exports__ = /*#__PURE__*/(0,exportHelper/* default */.A)(planvue_type_script_setup_true_lang_js, [['__scopeId',"data-v-0a287d53"]])
