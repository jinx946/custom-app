"use strict";
(self["webpackChunktest"] = self["webpackChunktest"] || []).push([[260],{
...
// EXTERNAL MODULE: ./node_modules/@cesium/engine/Source/Core/Ion.js
var Ion = __webpack_require__(94088);
// EXTERNAL MODULE: ./node_modules/@cesium/widgets/Source/Viewer/Viewer.js + 382 modules
var Viewer = __webpack_require__(93312);
// EXTERNAL MODULE: ./node_modules/@cesium/engine/Source/Scene/Terrain.js + 1 modules
var Terrain = __webpack_require__(79632);
// EXTERNAL MODULE: ./node_modules/@cesium/engine/Source/Scene/createOsmBuildingsAsync.js + 2 modules
var createOsmBuildingsAsync = __webpack_require__(19092);
// EXTERNAL MODULE: ./node_modules/@cesium/engine/Source/Core/Cartesian3.js
var Cartesian3 = __webpack_require__(85584);
// EXTERNAL MODULE: ./node_modules/@cesium/engine/Source/Core/Color.js
var Color = __webpack_require__(57492);
// EXTERNAL MODULE: ./node_modules/@cesium/engine/Source/Core/JulianDate.js
var JulianDate = __webpack_require__(42192);
// EXTERNAL MODULE: ./node_modules/@cesium/engine/Source/DataSources/SampledPositionProperty.js + 3 modules
var SampledPositionProperty = __webpack_require__(85564);
// EXTERNAL MODULE: ./node_modules/@cesium/engine/Source/Core/TimeIntervalCollection.js
var TimeIntervalCollection = __webpack_require__(79336);
// EXTERNAL MODULE: ./node_modules/@cesium/engine/Source/Core/TimeInterval.js
var TimeInterval = __webpack_require__(49980);
// EXTERNAL MODULE: ./node_modules/@cesium/engine/Source/DataSources/PathGraphics.js
var PathGraphics = __webpack_require__(72672);
// EXTERNAL MODULE: ./node_modules/@cesium/engine/Source/Core/IonResource.js
var IonResource = __webpack_require__(46520);
// EXTERNAL MODULE: ./node_modules/@cesium/engine/Source/DataSources/VelocityOrientationProperty.js + 1 modules
var VelocityOrientationProperty = __webpack_require__(31944);
;// CONCATENATED MODULE: ./data/line-fly.js
...
;// CONCATENATED MODULE: ./node_modules/vue-loader/dist/index.js??ruleSet[1].rules[6].use[0]!./src/web/view/cesiumDemo/index.vue?vue&type=script&setup=true&lang=js


const _withScopeId = n => ((0,runtime_core_esm_bundler/* pushScopeId */.ED)("data-v-065976c3"),n=n(),(0,runtime_core_esm_bundler/* popScopeId */.ii)(),n)
const _hoisted_1 = { class: "cesium-demo" }
const _hoisted_2 = /*#__PURE__*/ _withScopeId(() => /*#__PURE__*/(0,runtime_core_esm_bundler/* createElementVNode */.QD)("div", { id: "cesiumContainer" }, null, -1 /* HOISTED */))
const _hoisted_3 = { class: "tool-list" }
...
// cesium 配置项
Ion/* default */.c.defaultAccessToken =
...
function createViewer() {
  // 创建视图
  viewer = new Viewer/* default */.c('cesiumContainer', {
    terrain: Terrain/* default */.c.fromWorldTerrain(), //地形，世界地形地图
    infoBox: false, //禁用
  });
}
async function addBuild() {
  // 添加 建筑数据
  const osmBuildings = await createOsmBuildingsAsync/* default */.c();
...
function addPoint() {
  ...
  const pointEntity = viewer.entities.add({
    ...
    position: Cartesian3/* default */.c.fromDegrees(
      dataPoint.longitude,
      dataPoint.latitude,
      dataPoint.height
    ),
    point: { pixelSize: 10, color: Color/* default */.c.RED },
  });
...
function addFlyTime() {
  ...
  start = JulianDate/* default */.c.fromIso8601('2020-03-09T23:10:00Z');
  stop = JulianDate/* default */.c.addSeconds(
    start,
    totalSeconds,
    new JulianDate/* default */.c()
  );
  ...
  positionProperty = new SampledPositionProperty/* default */.c();

  for (let i = 0; i < flightData.length; i++) {
    const dataPoint = flightData[i];
    const time = JulianDate/* default */.c.addSeconds(
      start,
      i * timeStepInSeconds,
      new JulianDate/* default */.c()
    );
    // 创建一个点
    const position = Cartesian3/* default */.c.fromDegrees(
      dataPoint.longitude,
      dataPoint.latitude,
      dataPoint.height
    );
  ...
  const airplaneEntity = viewer.entities.add({
    availability: new TimeIntervalCollection/* default */.c([
      new TimeInterval/* default */.c({ start: start, stop: stop }),
    ]),
    position: positionProperty,
    point: { pixelSize: 30, color: Color/* default */.c.RED },
    path: new PathGraphics/* default */.c({ width: 3 }),
  });
  // 使摄像机跟踪实体
...
async function loadModel() {
  ...
  //  加载模型
  const airplaneUri = await IonResource/* default */.c.fromAssetId(2539726);
  const airplaneEntity = viewer.entities.add({
    availability: new TimeIntervalCollection/* default */.c([
      new TimeInterval/* default */.c({ start: start, stop: stop }),
    ]),
    ...
    orientation: new VelocityOrientationProperty/* default */.c(positionProperty),
    path: new PathGraphics/* default */.c({ width: 3 }),
  });
...
function distanceTo() {
  let left = {},
    right = {};
  Cartesian3/* default */.c.distance(left, right);
}
    ...
    (0,runtime_core_esm_bundler/* createElementVNode */.QD)("div", _hoisted_3, [
      (0,runtime_core_esm_bundler/* createVNode */.K2)(_component_el_button, {
        ...
        default: (0,runtime_core_esm_bundler/* withCtx */.Ql)(() => [
          (0,runtime_core_esm_bundler/* createTextVNode */.mY)(" 距离测量 ")
        ]),
        _: 1 /* STABLE */
      })
    ])
...
;// CONCATENATED MODULE: ./src/web/view/cesiumDemo/index.vue?vue&type=script&setup=true&lang=js
 
// EXTERNAL MODULE: ./node_modules/vue-loader/dist/exportHelper.js
var exportHelper = __webpack_require__(18152);
;// CONCATENATED MODULE: ./src/web/view/cesiumDemo/index.vue
...
const __exports__ = /*#__PURE__*/(0,exportHelper/* default */.c)(cesiumDemovue_type_script_setup_true_lang_js, [['__scopeId',"data-v-065976c3"]])
